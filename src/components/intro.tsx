  ...
  return (
    ...
    >
      <motion.a
        ...
        href="https://github.com/jairock007/SmoothieMaker"
      ...
      >
        Front-end developer with a passion for coding
      </motion.h1>
      <motion.p
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <Button variant="secondary" size="icon" asChild>
          <a
            href="https://www.linkedin.com/in/jitendra-singh-780aa7147"
            aria-label="Linkedin"
            download
          >
        ...
        <Button variant="secondary" size="icon" asChild>
          <a href="https://github.com/jairock007" aria-label="Github">
